...
for i in range(0,400):
	...
	while(j<10):
		...
		while(k<10):			
			...
			sum = sum + 1
			longitude = longitude + 0.0008993216/4;
			k = k + 1
			if k==9:
				f_longitude = longitude
		j = j + 1
		k=0
		latitude  = latitude - 0.0008993216/4;
		# ref =ref + "\n"
	ref  =ref[:-1]
	api_link = "https://roads.googleapis.com/v1/nearestRoads?points="+ref+"&key=AIzaSyAtyh3XgY8KPHuDygUZfyjL-6SXcGGogw8"
